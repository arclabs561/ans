...
Thanks for your interest. ans is rANS entropy coding with bits-back primitives. no_std, zero dependencies.
...
- Commit messages: `ans: short lowercase description`. One commit per logical change.
